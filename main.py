...
while loop:
    ...
    request = yt.playlists().insert(
        ...
        body={
            "snippet": {
                "title": f"Top 100 Songs of {target_date}",
                "description": f"The Billboard Hot 100's top songs for {target_date}"
            },
            "status": {
    ...
    user_loop = input("Operation Complete\nWould you like to continue (y/n)? ")
    loop = user_loop.lower() == "y"